...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet('https://raw.githubusercontent.com/Emerson2-creator/Scripts-Roblox/refs/heads/main/Scripts/Dig%20the%20Backyard%20Script'))()
